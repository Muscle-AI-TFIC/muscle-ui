...
export function TrainingSheetList({ trainingSheets, expandedDay, toggleDay, removeDay, newExercise, setNewExercise, addExercise, toggleExerciseCompletion, removeExercise, setIsAddDayModalVisible, handleSave }: TrainingSheetListProps) {
  return (
    <FlatList
      data={trainingSheets}
      ...
      ListFooterComponent={
        <>
          <TouchableOpacity onPress={() => setIsAddDayModalVisible(true)} style={styles.addDayButton}>
