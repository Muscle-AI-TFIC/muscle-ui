import { Text, View, TouchableOpacity, ScrollView, TextInput, Modal, ActivityIndicator } from 'react-native';
          ...
          <ScrollView style={styles.modalBody}>
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => setUserInfo(userInfo ? { ...userInfo, weight_kg: parseFloat(text) || 0 } : null)}
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  ...
                  setUserInfo(userInfo ? { ...userInfo, height_cm: heightValue } : null);
                }}
                keyboardType="numeric"
                placeholder="Ex: 175"
              />
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => setUserInfo(userInfo ? { ...userInfo, birth_date: text } : null)}
              ...
              <View style={styles.optionsContainer}>
                {[
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => setUserInfo(userInfo ? { ...userInfo, gender: gen.value } : null)}
                  >
                    <Text style={[
                      styles.optionText,
              ...
              <View style={styles.optionsContainer}>
                {[
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => setUserInfo(userInfo ? { ...userInfo, goal: obj.value } : null)}
                  >
                    <Text style={[
                      styles.optionText,
              ...
              <View style={styles.optionsContainer}>
                {[
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => setUserInfo(userInfo ? { ...userInfo, fitness_level: nivel.value } : null)}
                  >
                    <Text style={[
                      styles.optionText,
